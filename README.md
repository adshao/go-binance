...
```shell
go get github.com/dinosaurchi/go-binance/v2
```
...
```golang
import (
    "github.com/dinosaurchi/go-binance/v2"
)
```
...
```go
import (
    "github.com/dinosaurchi/go-binance/v2/futures"
)
...
```go
import (
    "github.com/dinosaurchi/go-binance/v2/delivery"
)
