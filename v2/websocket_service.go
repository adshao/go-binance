...
type WsOrderUpdate struct {
	...
	QuoteVolume             string          `json:"Q"`
	TrailingTime            int64           `json:"D"` // This is only visible if the trailing stop order has been activated.
	StrategyId              int             `json:"j"` // This is only visible if the strategyId parameter was provided upon order placement
	StrategyType            int64           `json:"J"` // This is only visible if the strategyType parameter was provided upon order placement
	WorkingTime             int64           `json:"W"` // This is only visible if the order has been placed on the book.
