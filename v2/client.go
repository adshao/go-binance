...
import (
	...
	"github.com/lesterlaucn/go-binance/v2/common"
	"github.com/lesterlaucn/go-binance/v2/delivery"
	"github.com/lesterlaucn/go-binance/v2/futures"
)
...
// Endpoints
const (
	baseAPIMainURL    = "https://api.binancezh.sh"
